...
public class DatosDeActividadA2 : MonoBehaviour
{
    ...
    public string nombreActividad = "Ayuda_al_chef";
    ...
    public int mejorMarcador = 0;           //Mejor cantidad de platos correctos entre todos los intentos
    ...
    public int tocoBotonCambioHabitacion = 0;      //Cuantas veces ha tocado el boton para ir a la cocina o despensa
    public int tocoFondoBotonera = 0;        //Cuantas veces ha tocado el fondo de la botonera
    ...
    public void registrarToqueCambioHabitacion()
    {
        tocoBotonCambioHabitacion++;
    }
