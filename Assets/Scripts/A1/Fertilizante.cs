...
public class Fertilizante : MonoBehaviour {
    ...
    public static Fertilizante instanciaCompartida;
    ...
    void Start()
    {
        ...
        Debug.Log("Posicion inicial de Fertilizante: " + ubicacion);
    }
    ...
    private void OnMouseUp()
    {
        if (true)
        {
            ...
            Debug.Log("Retorno de posicion de Fertilizante: " + ubicacion);
            Macetero.instanciaCompartida.Simulado();
        }
    }
